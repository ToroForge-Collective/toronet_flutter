...
Future<Map<String, dynamic>> bridgeTokenPolygonApi({
  required Dio dio,
...
Future<Map<String, dynamic>> getBalancePolygonApi({
  required Dio dio,
  required String baseUrl,
...
Future<Map<String, dynamic>> getTokenBalancePolygonApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String contractAddress,
...
Future<List<Map<String, dynamic>>> getTransactionsPolygonApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String admin,
...
Future<List<Map<String, dynamic>>> getTokenTransactionsPolygonApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String contractAddress,
...
Future<Map<String, dynamic>> paymentInitializePolygonApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String password,
...
Future<Map<String, dynamic>> recordFiatTransactionPolygonApi({
  required Dio dio,
  required String baseUrl,
  required String currency, // USDCPOLY
