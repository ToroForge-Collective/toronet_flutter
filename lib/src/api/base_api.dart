...
Future<Map<String, dynamic>> bridgeTokenBaseApi({
  required Dio dio,
...
Future<Map<String, dynamic>> getBalanceBaseApi({
  required Dio dio,
  required String baseUrl,
...
Future<Map<String, dynamic>> getTokenBalanceBaseApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String contractAddress,
...
Future<List<Map<String, dynamic>>> getTransactionsBaseApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String admin,
...
Future<List<Map<String, dynamic>>> getTokenTransactionsBaseApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String contractAddress,
...
Future<Map<String, dynamic>> paymentInitializeBaseApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String password,
...
Future<Map<String, dynamic>> recordFiatTransactionBaseApi({
  required Dio dio,
  required String baseUrl,
  required String currency, // USDCBASE
