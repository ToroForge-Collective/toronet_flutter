...
Future<Map<String, dynamic>> bridgeTokenBscApi({
  required Dio dio,
...
Future<Map<String, dynamic>> getBalanceBscApi({
  required Dio dio,
  required String baseUrl,
...
Future<Map<String, dynamic>> getTokenBalanceBscApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String contractAddress,
...
Future<List<Map<String, dynamic>>> getTransactionsBscApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String admin,
...
Future<List<Map<String, dynamic>>> getTokenTransactionsBscApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String contractAddress,
...
Future<Map<String, dynamic>> paymentInitializeBscApi({
  required Dio dio,
  required String baseUrl,
  required String address,
  required String password,
...
Future<Map<String, dynamic>> recordFiatTransactionBscApi({
  required Dio dio,
  required String baseUrl,
  required String currency, // USDTBSC
